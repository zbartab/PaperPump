...
We downloaded the `dblp` publication database, which covers computational sciences.
...
plot(m.bins, as.numeric(t.ll), pch=16, bty="l", xlab="number of papers",
		 ylab="frequency", log="xy")
```
